...
import CarInContainer from './pages/carInContainer';
import Flexibags from './pages/flexibags';

// HomePage Component - Contains all your existing homepage content
function HomePage() {
      ...
      <section className="relative py-10 px-8 md:px-16 lg:px-24 bg-white overflow-visible">
        <div className="max-w-7xl mx-auto text-center" style={{ marginLeft: '300px' }}>
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl text-gray-900 leading-tight mb-6 font-light">
            ...
            <span className="font-light">to go all the way</span>
          </h2>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-12">
            Logistics can get messy fast. And just when you think you're done, another challenge appears. 
            With Trident as your partner, you don't have to face challenges alone. We bring clarity where 
            complexity builds. Whether it's one service or a complete solution, you stay ready for what 
            comes next.
          </p>

          {/* Video Container with Curved Borders - Top and Bottom */}
          <div className="relative inline-block w-full max-w-5xl mx-auto overflow-visible">
            {/* Video with Curve on Top and Bottom */}
            <div 
            ...
            >
              ...
              >
                <source src="/be_ready.mp4" type="video/mp4" />
                Your browser does not support the video tag.
              </video>
            </div>
      ...
      <section className="py-10 px-8 md:px-16 lg:px-24 bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            {activeTab === 'logistics' && (
              <>
                ...
                {/* Cold Storage Card - Already correct */}
                ...
                {/* Cold Chain Logistics Card - Change href to /cold-storage */}
                <a href="/cold-storage" className="group block bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 w-80 flex-shrink-0">
                  <div className="w-full h-48 bg-gray-100 flex items-center justify-center overflow-hidden">
          ...
          >
            ...
            {/* Two Column Blocks Section - Text Left, Image Right Style */}
        ...
        <div className="max-w-7xl mx-auto space-y-20" style={{ marginLeft: '300px' }}>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl text-gray-900 leading-tight mb-4 font-light">
                The Trident East-West Network
              </h2>
              <div className="w-16 h-0.5 bg-blue-500 mb-6"></div>
              <p className="text-gray-600 leading-relaxed mb-6">
                With our East-West Network we are setting a new standard for reliability and service quality 
                by reducing port calls on our mainliners, an extensive shuttle network and strategically 
                located hubs delivering world class productivity.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <div className="w-16 h-0.5 bg-blue-500 mb-6"></div>
              <p className="text-gray-600 leading-relaxed mb-6">
                When navigating the evolving world of logistics, knowing and acting on the top trends will 
                help you go all the way.
              </p>
              <button className="text-blue-600 font-medium hover:text-blue-700 transition-colors flex items-center gap-2">
                Discover new trends <span>→</span>
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/about" className="text-gray-400 hover:text-white transition-colors text-sm">Contact Us</a></li>
              </ul>
            </div>
          </div>
    ...
    <Router>
      <div className="min-h-screen bg-white font-sans" style={{ fontFamily: 'Verdana, sans-serif' }}>
        ...
        <Routes>
          ...
          <Route path="/special-shipment" element={<SpecialCargo />} />
          <Route path="/supply-chain-management" element={<SCM />} />
          <Route path="/garments-on-hanger" element={<GOH />} />
          <Route path="/cars-in-containers" element={<CarInContainer />} />
